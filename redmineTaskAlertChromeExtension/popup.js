        ...
        if (document.readyState === "interactive") {
            ...
            if (taskType === "Development") {
                ...
                var redmineTaskNumber = window.location.href
                    ...
                    .substring(0, 5);
                // Status
                var redmineTaskStatus = document.querySelector(".status.attribute > .value").textContent;
                // MR status
                var redmineMrStatus = document.querySelector(".cf_26.attribute > .value").textContent;
                // Test status
                var redmineTestStatus = document.querySelector(".cf_4.attribute > .value").textContent;
                // Deployed to Sandbox status
                // Note: Empty field returns an empty string.
                var redmineDeployedToSandbox = document.querySelector(".cf_11.attribute > .value").textContent;
                /*
